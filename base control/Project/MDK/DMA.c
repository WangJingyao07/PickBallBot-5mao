...
void data_pack(void)
{
	...
	com_x_send_data.x_pos.fv += linear_x;//x坐标
	com_x_send_data.y_pos.fv += linear_y;//y坐标
	com_x_send_data.x_v.fv	= linear_x;//x方向速度
	com_x_send_data.y_v.fv = linear_y;//y 方向速度
	com_x_send_data.angular_v.fv = angular_z;//角速度 绕z轴
	com_x_send_data.pose_angular.fv += angular_z;//yaw偏航角 
